...
import {Navbar} from "./items/landing/Navbar";
...
const TopButton: FC = () => {
    ...
    return (
        <motion.div
            ...
            className="fixed bottom-10 right-10 z-50 cursor-pointer rounded-full transition-colors bg-[#E9EBEF] dark:bg-[#1F2B49] text-[#161616] dark:text-white p-3 hover:bg-[#98BDE7] "
