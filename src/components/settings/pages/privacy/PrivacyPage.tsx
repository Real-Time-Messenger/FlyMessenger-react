import { LastActivityModeDropdown } from "../dropdowns";
import { FC, useState } from "react";
import { useTranslation } from "react-i18next";
import {useAppDispatch, useStateSelector} from "../../../../stores/hooks";
import { SettingsItem } from "../../items";
import {ArrangeHorizontalIcon, GroupOfPeopleIcon, KeySquareIcon, MonitorIcon, ProfileTickIcon} from "../../../icons";
...
export const PrivacyPage: FC = () => {
	...
	/**
	 * Updates the current User `twoFactorEnabled` setting.
	 */
