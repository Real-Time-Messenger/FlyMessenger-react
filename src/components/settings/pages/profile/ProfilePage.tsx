import { ChangeDisplayNameModal, ChangeEmailModal } from "../modals";
import { PhotoChanger } from "./items/PhotoChanger";
...
import {AtSignIcon, MailIcon, ProfileIcon } from "../../../icons";
			...
			<div className="flex flex-col">
				<div className="mb-2.5 flex flex-col items-center justify-center gap-2.5 border-b-[10px] border-b-[#CFD0D4] p-2.5 pb-2.5 dark:border-b-[#2F384E65]">
					...
					<div className="flex w-full flex-col items-center">
						...
						<span className="select-none text-sm text-[#7CADE0] dark:text-[#4C70E0]">{t("users.status.online")}</span>
					</div>
				</div>
