...
export const DialogActionsMenu: FC<DialogActionsMenuProps> = ({isUserSearching, user}) => {
    const [isSearching, setIsSearching] = useState<boolean>(isUserSearching);
        ...
        <>
            <button
                className={classNames(
                    "items-center justify-center rounded-full p-2 transition-[background-color] hover:bg-[#C1C1C165] dark:hover:bg-[#2F384E65] hidden sm:flex",
                    isSearching && "bg-[#C1C1C165] dark:bg-[#2F384E65]",
                )}
            ...
            <button
                className="items-center justify-center rounded-full p-2 transition-[background-color] hover:bg-[#C1C1C165] dark:hover:bg-[#2F384E65] flex sm:hidden"
...
const DialogActionsMenuDropdown: FC<ModalProps> = ({isOpened, onClose}) => {
    ...
    return (
        <>
            ...
            <Dropdown isOpened={isOpened} onClose={onClose} className="top-12 right-0 w-[200px] transition-colors flex lg:!hidden">
                <Dropdown.Item
                ...
                <Dropdown.Item
                    className="flex gap-3 px-3 py-2 items-center active:bg-[#C1C1C165] dark:active:bg-[#2F384E65]" onClick={tryToBlockUser}>
                ...
                <Dropdown.Item
                    className="flex gap-3 px-3 py-2 items-center text-[#E86C6C] dark:text-[#E86C6C]" onClick={() => setDeleteDialogAlert(true)}>
